...
class AddScheduleTabAdapter(fm: FragmentManager, private val context: Context) : FragmentStatePagerAdapter(fm) {

    private val inflater = LayoutInflater.from(context)
    private val title = arrayOf<String>("Taskの追加", "Memoの追加")
